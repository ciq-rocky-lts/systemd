...
Patch9000: 9000-Don-t-GC-unit-if-it-is-in-another-queue.patch
Patch9998: 9998-rocky-test-cgroup.patch

# CVE-2025-4598:
Patch10001: CVE-2025-4598-0001-basic-parse-util-add-helper-to-parse-bounded-unsigne.patch
Patch10002: CVE-2025-4598-0002-coredump-get-rid-of-_META_MANDATORY_MAX.patch
Patch10003: CVE-2025-4598-0003-coredump-use-d-in-kernel-core-pattern.patch
...
%changelog
* Sat Aug 16 2025 Jeff Uphoff <juphoff@ciq.com> - 252-33.10
- Add rocky-test-cgroup patch

* Wed Aug 13 2025 Jeff Uphoff <juphoff@ciq.com> - 252-33.9
- Fix CVE-2025-4598

* Wed Oct 15 2024 Matt Hink <mhink@ciq.com> - 252-33.8
- Version bump.

* Tue Oct 15 2024 Skip Grube <sgrube@ciq.com> - 252-32.8.0.1
- Rebuild due to missing architecture, no code changes.

* Fri Oct 04 2024 Matt Hink <mhink@ciq.com> - 252-32.8
- Don't GC unit if it is in another queue
